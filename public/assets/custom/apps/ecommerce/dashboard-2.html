...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>ECommerce Dashboard 2 | Keenthemes</title>
											...
											<div class="card-body">
												...
												<div class="row">
													...
													<div class="col-md-4 col-lg-12 col-xxl-4">
														...
														<div class="card card-custom card-stretch gutter-b">
															<div class="card-body d-flex flex-column rounded bg-light-primary justify-content-between">
																<div class="rounded text-center mb-7 pt-7">
																	<img src="assets/media/products/14.png" class="mw-100 w-200px" style="transform: scale(1.4);" />
																</div>
													...
													<div class="col-md-4 col-lg-12 col-xxl-4">
														<div class="card card-custom gutter-b card-stretch">
															<div class="card-body d-flex flex-column rounded bg-light justify-content-between">
																...
																<div>
																	<h4 class="font-size-h5">
																		<a href="#" class="text-dark-75 font-weight-bolder">Spine Friendly Chair</a>
																	</h4>
																	<div class="font-size-h6 text-muted font-weight-bolder">$370.00</div>
																</div>
															</div>
													...
													<div class="col-md-4 col-lg-12 col-xxl-4">
														<div class="card card-custom gutter-b card-stretch">
															<div class="card-body d-flex flex-column rounded bg-light justify-content-between">
																...
																<div>
																	<h4 class="font-size-h5">
																		<a href="#" class="text-dark-75 font-weight-bolder">Yellow Kettle</a>
																	</h4>
																	<div class="font-size-h6 text-muted font-weight-bolder">$370.00</div>
																</div>
															</div>
													...
													<div class="col-md-4 col-lg-12 col-xxl-4">
														<div class="card card-custom gutter-b card-stretch">
															<div class="card-body d-flex flex-column rounded bg-light justify-content-between">
																...
																<div>
																	<h4 class="font-size-h5">
																		<a href="#" class="text-dark-75 font-weight-bolder">Amazing Mats</a>
																	</h4>
																	<div class="font-size-h6 text-muted font-weight-bolder">$370.00</div>
																</div>
															</div>
