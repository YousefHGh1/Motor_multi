        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <a href="{{ route('mainservices.create') }}"
                        class="card-label font-weight-bolder text-dark">{{ __('words.mainservices') }}</a>
                </h3>
                                                ...
                                                @if ($key == 'ar')
                                                    <td class="pl-0 py-4">
                                                        <div class="symbol symbol-50 symbol-light">
                                                            ...
                                                            <img src="{{ asset('fileimage1/' . $mainservice->image1) }}"
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            ...
                                                            {{ $mainservice->translate($key)->main_title }}
                                                        </span>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $mainservice->translate($key)->description }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        ...
                                                        <a href="{{ route('mainservices.edit', $mainservice->id) }}"
                                                        ...
                                                        <form method="POST"
                                                            action="{{ url('/mainservices' . '/' . $mainservice->id) }}"
                                                            accept-charset="UTF-8" style="display:inline">
                                                            {{ method_field('DELETE') }} {{ csrf_field() }}
                                                            <button type="submit"
                                                                class="btn btn-icon btn-light btn-hover-primary btn-sm"
                                                                title="Delete mainservice"
