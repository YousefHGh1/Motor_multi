            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <a href="{{ route('subservices.create') }}"
                        class="card-label font-weight-bolder text-dark">{{ __('words.subservices') }}</a>
                </h3>
                            ...
                            <table class="table table-borderless table-vertical-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="p-0 min-w-110px">{{ __('words.long_title_logo') }}</th>
                                                ...
                                                @if ($key == 'ar')
                                                    <td class="pl-0 py-4">
                                                        <div class="symbol symbol-50 symbol-light">
                                                            ...
                                                            <img src="{{ asset('fileimage1/' . $subservice->image1) }}"
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            ...
                                                            {{ $subservice->translate($key)->logo_title }}
                                                        </span>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $subservice->translate($key)->short_title_logo }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $subservice->translate($key)->long_title_logo }}
                                                        </span>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ url('/subservices' . '/' . $subservice->id) }}"
