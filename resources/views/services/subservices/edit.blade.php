                ...
                <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="between" data-wizard-clickable="true">
                    ...
                    <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                        <div class="col-xl-12 col-xxl-7">
                            ...
                            <form action="{{ route('subservices.update', $subservices->id) }}" id="kt_form" method="post"
                                    ...
                                    <div class="pb-5 @if ($loop->index == 0) show active in @endif"
                                        ...
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $subservices->translate($key)->logo_title }}">
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Input-->
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $subservices->translate($key)->short_title_logo }}"
                                        ...
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $subservices->translate($key)->long_title_logo }}">
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Input-->
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            <label>{{ __('words.management_sub_id') }}</label>
                                            <select class="form-control selectpicker" data-size="7" tabindex="null"
                                                data-live-search="true" title="ادخل قسم الادارة ..."
                                                name="management_sub_id" id="management_sub_id">
                                                @foreach ($management_sub->sortBy('created_at') as $manage_sub)
                                                    <option value="{{ $manage_sub->id }}"
                                                        {{ $subservices->management_sub_id == $manage_sub->id ? 'selected' : '' }}>
                                                        {{ $manage_sub->logo_title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    ...
                                    <div class="form-group fv-plugins-icon-container has-success">
                                        ...
                                        @if ($subservices->image1)
                                            <img src="{{ asset('fileimage1/' . $subservices->image1) }}" alt="image1 Image"
                                    ...
                                    <div class="form-group fv-plugins-icon-container has-success">
                                        ...
                                        @if ($subservices->logo)
                                            <img src="{{ asset('filelogo/' . $subservices->logo) }}" alt="logo Image"
                                                class="mt-3" style="max-width: 100px;">
                                        @endif
                                    </div>
                                    <!--end::Input-->
