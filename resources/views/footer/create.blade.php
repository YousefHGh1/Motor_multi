                ...
                <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="between" data-wizard-clickable="true">
                    ...
                    <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                        <div class="col-xl-12 col-xxl-7">
                            <!--begin: Wizard Form-->
                            <form action="{{ route('footer.store') }}" id="kt_form" method="post"
                                    ...
                                    <div class="pb-5 @if ($loop->index == 0) show active in @endif"
                                        ...
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control" name="{{ $key }}[address]"
                                                id="address" placeholder="{{ __('words.address') }}">
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Input-->
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control" name="{{ $key }}[allsave]"
                                                id="allsave" placeholder="{{ __('words.allsave') }}">
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                @endforeach
