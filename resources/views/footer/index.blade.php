            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <a href="{{ route('footer.create') }}"
                        class="card-label font-weight-bolder text-dark">{{ __('words.footer') }}</a>
                </h3>
                            ...
                            <table class="table table-borderless table-vertical-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="p-0 min-w-100px">{{ __('words.logo') }}</th>
                                                ...
                                                @if ($key == 'ar')
                                                    <td class="pl-0 py-4">
                                                        <div class="symbol symbol-50 symbol-light">
                                                            ...
                                                            <img src="{{ asset('fileimage1/' . $footer->image1) }}"
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <div class="symbol symbol-50 symbol-light">
                                                            {{-- <span class="symbol-label"> --}}
                                                            <img src="{{ asset('filelogo/' . $footer->logo) }}"
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            ...
                                                            {{ $footer->translate($key)->description }}
                                                        </span>
                                                    </td>
                                                    <td class="pl-0 py-4">
