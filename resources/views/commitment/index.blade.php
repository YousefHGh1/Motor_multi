        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <a href="{{ route('commitment.create') }}"
                        class="card-label font-weight-bolder text-dark">{{ __('words.commitment') }}</a>
                </h3>
                                                ...
                                                @if ($key == 'ar')
                                                    <td class="pl-0 py-4">
                                                        <div class="symbol symbol-50 symbol-light">
                                                            ...
                                                            <img src="{{ asset('fileimage1/' . $commitment->image1) }}"
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            ...
                                                            {{ $commitment->translate($key)->main_title }}
                                                        </span>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $commitment->translate($key)->description }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        ...
                                                        <a href="{{ route('commitment.edit', $commitment->id) }}"
                                                        ...
                                                        <form method="POST"
                                                            action="{{ url('/commitment' . '/' . $commitment->id) }}"
