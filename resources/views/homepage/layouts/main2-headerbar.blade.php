  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-center">
        <nav id="navbar" class="navbar">
          <img src="{{ asset('assets/homepage/img/black-logo.svg') }}" width="200px" height="40px" alt="black-logo">
            <ul>

              <li>
                <a class="nav-link scrollto active" href="{{ route('homepage.index') }}">{{ __('words.home') }}</a>
            </li>
