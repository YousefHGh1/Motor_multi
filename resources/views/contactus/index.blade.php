            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <a href="{{ route('contactus.create') }}"
                        class="card-label font-weight-bolder text-dark">{{ __('words.contactus') }}</a>
                </h3>
                                                ...
                                                @if ($key == 'ar')
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            ...
                                                            {{ $contactus->translate($key)->main_title }}
                                                        </span>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $contactus->translate($key)->description }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ url('/contactus' . '/' . $contactus->id) }}"
