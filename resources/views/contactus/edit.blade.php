                ...
                <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="between" data-wizard-clickable="true">
                    ...
                    <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                        <div class="col-xl-12 col-xxl-7">
                            ...
                            <form action="{{ route('contactus.update', $contactus->id) }}" id="kt_form" method="post"
                                    ...
                                    <div class="pb-5 @if ($loop->index == 0) show active in @endif"
                                        ...
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $contactus->translate($key)->main_title }}">
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Input-->
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $contactus->translate($key)->description }}">
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Input-->
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control" name="{{ $key }}[address1]"
                                                id="address1" value="{{ $contactus->translate($key)->address1 }}">
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Input-->
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control" name="{{ $key }}[address2]"
                                                value="{{ $contactus->translate($key)->address2 }}">
                                        </div>
                                        <!--end::Input-->
