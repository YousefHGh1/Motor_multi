                ...
                <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="between" data-wizard-clickable="true">
                    ...
                    <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                        <div class="col-xl-12 col-xxl-7">
                            ...
                            <form action="{{ route('qa.update', $qa->id) }}" id="kt_form" method="post"
                                    ...
                                    <div class="pb-5 @if ($loop->index == 0) show active in @endif"
                                        ...
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control" name="{{ $key }}[question]"
                                                id="question" value="{{ $qa->translate($key)->question }}">
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Input-->
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            <label>{{ __('words.answer') }}</label>
                                            <input type="text" class="form-control" name="{{ $key }}[answer]"
                                                value="{{ $qa->translate($key)->answer }}"
                                                placeholder="{{ __('words.answer') }}">
                                        </div>
                                        <!--end::Input-->
                                ...
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    ...
                                    <div class="form-group fv-plugins-icon-container has-success">
                                        ...
                                        @if ($qa->image1)
                                            <img src="{{ asset('fileimage1/' . $qa->image1) }}" alt="image1 Image"
