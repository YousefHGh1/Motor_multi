        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <a href="{{ route('qaintro.create') }}"
                        class="card-label font-weight-bolder text-dark">{{ __('words.qaintro') }}</a>
                </h3>
                            ...
                            <table class="table table-borderless table-vertical-center">
                                ...
                                <tbody>
                                    @foreach (config('app.language') as $key => $lang)
                                        @foreach ($qaintros as $qaintro)
                                            <tr>
                                                @if ($key == 'ar')
                                                    <td class="pl-0 py-4">
                                                        <div class="symbol symbol-50 symbol-light">
                                                            {{-- <span class="symbol-label"> --}}
                                                            <img src="{{ asset('fileimage1/' . $qaintro->image1) }}"
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            ...
                                                            {{ $qaintro->translate($key)->main_title }}
                                                        </span>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $qaintro->translate($key)->description }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        ...
                                                        <a href="{{ route('qaintro.edit', $qaintro->id) }}"
                                                        ...
                                                        <form method="POST"
                                                            action="{{ url('/qaintro' . '/' . $qaintro->id) }}"
                                                            accept-charset="UTF-8" style="display:inline">
                                                            {{ method_field('DELETE') }} {{ csrf_field() }}
                                                            <button type="submit"
                                                                class="btn btn-icon btn-light btn-hover-primary btn-sm"
                                                                title="Delete qaintro"
