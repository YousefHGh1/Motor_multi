        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <a href="{{ route('submanagement.create') }}"
                        class="card-label font-weight-bolder text-dark">{{ __('words.submanagement') }}</a>
                </h3>
                            ...
                            <table class="table table-borderless table-vertical-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="p-0 min-w-100px">{{ __('words.logo_title') }}</th>
                                        <th class="p-0 min-w-125px">{{ __('words.short_title_logo') }}</th>
                                        <th class="p-0 min-w-125px">{{ __('words.long_title_logo') }}</th>
                                                ...
                                                @if ($key == 'ar')
                                                    <td class="pl-0 py-4">
                                                        <div class="symbol symbol-50 symbol-light">
                                                            ...
                                                            <img src="{{ asset('fileimage1/' . $submanagement->image1) }}"
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            ...
                                                            {{ $submanagement->translate($key)->logo_title }}
                                                        </span>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $submanagement->translate($key)->short_title_logo }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $submanagement->translate($key)->long_title_logo }}
                                                        </span>
                                                    </td>

                                                    <td class="pl-0 py-4">

                                                        <a href="{{ route('submanagement.edit', $submanagement->id) }}"
                                                        ...
                                                        <form method="POST"
                                                            action="{{ url('/submanagement' . '/' . $submanagement->id) }}"
                                                            accept-charset="UTF-8" style="display:inline">
                                                            {{ method_field('DELETE') }} {{ csrf_field() }}
                                                            <button type="submit"
                                                                class="btn btn-icon btn-light btn-hover-primary btn-sm"
                                                                title="Delete submanagement"
