                ...
                <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="between" data-wizard-clickable="true">
                    ...
                    <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                        <div class="col-xl-12 col-xxl-7">
                            <!--begin: Wizard Form-->
                            <form action="{{ route('submanagement.update', $submanagement->id) }}" id="kt_form"
                                    ...
                                    <div class="pb-5 @if ($loop->index == 0) show active in @endif"
                                        ...
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $submanagement->translate($key)->logo_title }}">
                                        </div>
                                        <!--end::Input-->
                                        ...
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $submanagement->translate($key)->short_title_logo }}">
                                        </div>
                                        <!--end::Input-->
                                        ...
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $submanagement->translate($key)->long_title_logo }}">
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                @endforeach
                                ...
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    ...
                                    <div class="form-group fv-plugins-icon-container has-success">
                                        ...
                                        @if ($submanagement->image1)
                                            <img src="{{ asset('filelogo/' . $submanagement->logo) }}" alt="logo Image"
                                    ...
                                    <div class="form-group fv-plugins-icon-container has-success">
                                        ...
                                        @if ($submanagement->image1)
                                            <img src="{{ asset('fileimage1/' . $submanagement->image1) }}"
                                                alt="image1 Image" class="mt-3" style="max-width: 100px;">
                                        @endif
                                    </div>
                                    <!--end::Input-->
                                    <!--begin::Input-->
