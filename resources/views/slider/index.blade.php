            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <a href="{{ route('slider.create') }}"
                        class="card-label font-weight-bolder text-dark">{{ __('words.slider') }}</a>
                </h3>
                    ...
                    <div class="tab-pane fade active show" id="kt_tab_pane_11_1" role="tabpanel"
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless table-vertical-center">
                                <thead>
                                    <tr>
                                        <th class="p-0 w-200px">{{ __('words.logo') }}</th>
                                        <th class="p-0 min-w-200px">{{ __('words.background') }}</th>
                                        <th class="p-0 min-w-100px">{{ __('words.main_title') }}</th>
                                        <th class="p-0 min-w-125px">{{ __('words.description') }}</th>
                                        <th class="p-0 min-w-110px">{{ __('words.maintenance_button') }}</th>
                                        <th class="p-0 min-w-150px">{{ __('words.materials_button') }}</th>
                                        <th class="p-0 min-w-150px">{{ __('words.question') }}</th>
                                                ...
                                                @if ($key == 'ar')
                                                    <td class="pl-0 py-4">
                                                        <div class="symbol symbol-50 symbol-light">
                                                            ...
                                                            <img src="{{ asset('filelogos/' . $slider->logo) }}"
                                                                alt="Logo Image" class="mt-3 h-20 align-self-center"
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <div class="symbol symbol-50 symbol-light">
                                                            ...
                                                            <img src="{{ asset('filebackgrounds/' . $slider->background) }}"
                                                                alt="background Image" class="mt-3 h-20 align-self-center"
                                                                style="max-width: 200px;">
                                                            {{-- </span> --}}
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            ...
                                                            {{ $slider->translate($key)->main_title }}
                                                        </span>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $slider->translate($key)->description }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $slider->translate($key)->maintenance_button }}
                                                        </span>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $slider->translate($key)->materials_button }}
                                                        </span>
                                                    </td>
