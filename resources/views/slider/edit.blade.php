                ...
                <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="between" data-wizard-clickable="true">
                    ...
                    <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                        <div class="col-xl-12 col-xxl-7">
                            ...
                            <form action="{{ route('slider.update', $slider->id) }}" id="kt_form" method="post"
                                    ...
                                    <div class="pb-5 @if ($loop->index == 0) show active in @endif"
                                        ...
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $slider->translate($key)->main_title }}">
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Input-->
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $slider->translate($key)->description }}"
                                        ...
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $slider->translate($key)->maintenance_button }}">
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Input-->
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $slider->translate($key)->materials_button }}">
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Input-->
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control" name="{{ $key }}[question]"
                                                value="{{ $slider->translate($key)->question }}">
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                @endforeach
                                    ...
                                    <div class="form-group fv-plugins-icon-container has-success">
                                        ...
                                        @if ($slider->background)
                                            <img src="{{ asset('filebackgrounds/' . $slider->background) }}"
                                                alt="Background Image" class="mt-3" style="max-width: 100px;">
                                        @endif
                                    </div>
                                    <!--end::Input-->
                                    <!--begin::Input-->
                                    <div class="form-group fv-plugins-icon-container has-success">
                                        ...
                                        @if ($slider->logo)
                                            <img src="{{ asset('filelogos/' . $slider->logo) }}"
                                                alt="Logo Image" class="mt-3" style="max-width: 100px;">
                                        @endif
                                    </div>
                                    <!--end::Input-->
                                    <!--begin::Input-->
