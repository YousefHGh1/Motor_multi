                ...
                <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="between" data-wizard-clickable="true">
                    ...
                    <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                        <div class="col-xl-12 col-xxl-7">
                            ...
                            <form action="{{ route('about_us.update', $about_us->id) }}" id="kt_form" method="post"
                                    ...
                                    <div class="pb-5 @if ($loop->index == 0) show active in @endif"
                                        ...
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $about_us->translate($key)->main_title }}">
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Input-->
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $about_us->translate($key)->description }}"
                                        ...
                                        <div class="form-group fv-plugins-icon-container has-success">
                                            ...
                                            <input type="text" class="form-control" name="{{ $key }}[address]"
                                                value="{{ $about_us->translate($key)->address }}">
                                        </div>
                                        <!--end::Input-->
                                ...
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    ...
                                    <div class="form-group fv-plugins-icon-container has-success">
                                        ...
                                        @if ($about_us->image1)
                                            <img src="{{ asset('fileimage1/' . $about_us->image1) }}" alt="image1 Image"
                                    ...
                                    <!--begin::Input-->
                                    <div class="form-group fv-plugins-icon-container has-success">
                                        <label>{{ __('words.image2') }}</label>
                                        <input type="file" class="form-control" name="image2">
                                        @if ($about_us->image2)
                                            <img src="{{ asset('fileimage2/' . $about_us->image2) }}" alt="image2 Image"
                                                class="mt-3" style="max-width: 100px;">
                                        @endif
                                    </div>
                                    <!--end::Input-->
                                    ...
                                    <!--begin::Input-->
                                    <div class="form-group fv-plugins-icon-container has-success">
                                        <label>{{ __('words.image3') }}</label>
                                        <input type="file" class="form-control" name="image3">
                                        @if ($about_us->image3)
                                            <img src="{{ asset('fileimage3/' . $about_us->image3) }}" alt="image3 Image"
                                                class="mt-3" style="max-width: 100px;">
                                        @endif
                                    </div>
                                    <!--end::Input-->
