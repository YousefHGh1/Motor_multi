            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <a href="{{ route('about_us.create') }}"
                        class="card-label font-weight-bolder text-dark">{{ __('words.about_us') }}</a>
                </h3>
                            ...
                            <table class="table table-borderless table-vertical-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="p-0 min-w-110px">{{ __('words.address') }}</th>
                                                ...
                                                @if ($key == 'ar')
                                                    <td class="pl-0 py-4">
                                                        <div class="symbol symbol-50 symbol-light">
                                                            ...
                                                            <img src="{{ asset('fileimage1/' . $about_us->image1) }}"
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            ...
                                                            {{ $about_us->translate($key)->main_title }}
                                                        </span>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $about_us->translate($key)->description }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                                            {{ $about_us->translate($key)->address }}
                                                        </span>
                                                    ...
                                                    <td class="pl-0 py-4">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ url('/about_us' . '/' . $about_us->id) }}"
                                                            accept-charset="UTF-8" style="display:inline">
                                                            {{ method_field('DELETE') }} {{ csrf_field() }}
                                                            <button type="submit"
                                                                class="btn btn-icon btn-light btn-hover-primary btn-sm"
                                                                title="Delete about_us"
